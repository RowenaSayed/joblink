...
export default function LandingPage() {
  ...
  useEffect(() => {
    const fetchRecentJobs = async () => {
      try {
        const response = await fetch("https://joblink-server-app.vercel.app/api/jobs/");
    ...
    (!token&&) */}
      ...
      <main className=" container-fluid">
        <section className="hero row justify-content-center d-flex align-items-center pt-5">
          <section className="container bg-transparent text-center py-5">
        ...
        <section className="jobs bg-light py-5 mb-5">
