...
function Footer() {
  return (
    <footer className="py-1 shadow-sm border-top bg-light mt-auto sticky-bottom">
      <div className="container bg-light d-flex flex-wrap align-items-center justify-content-between gap-2">
